            ...
            if(!fs.existsSync(fontsFile)) {
                ...
                for(var i = 0; i < fontsFiles.length; i++) {
                    ...
                    if(newFileOnly !== fontFileName) {
                        let fontName = fontFileName.splite("-")[0] ? fontFileName.splite("-")[0] : fontFileName;
                        let fontWeight = fontFileName.splite("-")[1] ? fontFileName.splite("-")[1] : fontFileName;
